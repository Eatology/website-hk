...
$this->rules[480] = wfWAFRule::create($this, 480, NULL, 'bypass', '100', 'HTTP Request Smuggling', 0, 'log', new wfWAFRuleComparisonGroup(new wfWAFRuleComparison($this, 'match', '#(HEAD|GET|POST|OPTIONS)\\ \\/[^\\n]{1,512}HTTP\\/[12]#', array(wfWAFRuleComparisonSubject::create($this, 'request.rawBody', array (
))))));
