...
return array(
	'title'            => array(
		...
		'description' => '<p><a target="_blank" href="https://pay.google.com/business/console">' . __( 'GPay Console', 'woo-payment-gateway' ) . '</a></p> ' .
		                 ...
		                 '<p>' . __( 'To have the Google API team approve your integration you can enable sandbox mode and Google Pay. When sandbox mode is enabled, Google Pay will work, allowing you to capture the necessary screenshots the Google API team needs to approve your Merchant ID request.', 'woo-payment-gateway' ) . '</p>' .
