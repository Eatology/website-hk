    ...
    <?php if( have_rows('works') ): ?>
            <?php
                ...
                while ( have_rows('works') ) : the_row();       
                    ...
                    if ($svg) {
                        $svg = '<div data-rellax-speed="3" data-rellax-percentage="0.3" data-rellax-zindex="-2" class="rellax svg-span-wrapper">'.$svg. '</div>';
                    }
                    $image_tag = '';
                    $bg_circle = '<div data-rellax-speed="1" data-rellax-zindex="-1" class="rellax work-circle-wrapper">'.svg_circle('work-circle'). '</div>';

                    if( !empty( $image ) ):
                        $image_tag  = '<div class="img-wrapper"><img data-rellax-speed="1" data-rellax-zindex="5" class="rellax" src="'.esc_url($image['sizes']['wecreate_blog']).'" alt="'.esc_attr($image['alt']).'" /></div>';
                    endif;
