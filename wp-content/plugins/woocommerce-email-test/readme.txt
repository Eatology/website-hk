...
Are you looking for a system that will monitor your WooCommerce emails, to ensure they are working 24 hours a day? Then check out our new product [WooCommerce Email Monitor](https://ecomemailmonitor.co.uk/wordpress/woocommerce-email-monitor)
...
[WooCommerce Order Email Log](https://wordpress.org/plugins/order-emails-log-for-woocommerce/)
...
1. **Select an order for test email content**

2. **Click a button to generate the test email**

3. **View the email in your browser**

4. **Premium only - send the test email to any email address**

5. **Premium only - test additional email types, and woocommerce subscription emails**
...
= 1.2.1 =
* Fixed functions.php duplicate include
